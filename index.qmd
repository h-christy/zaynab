...
This project hopes by modeling "Political Islam" in the language of Probability Graphical Models with a historical survey data from the 1988, can help us an understanding of Islamic movements in one of its past, and the complexity for in modeling Political

As the Middle East entered its modern period, we witnessed the coming up of Islamic ideologies, Islamist movements and, observed concrete "popular support for Political Islam" as Islamists in the region emerged as major opposition groups further as the establishment of Islamic states. Reflecting the recognition of Islamists and Islamic political thoughts by the Middle Easterners, the phenomenon so called Political Islam is interesting not only because it is distinct viewing from "the West" which often discern that wrangling religion with politics is a going back since the course of history should be modernize and secularize. But because Political Islam has persisted to be one of the important characteristic of the politics of the Islamic World. The massive amount of scholarly research also indicates the importance of this topic as well as the now had repeatedly addressed multi-dimensionality and complexity in the academics. 

With the many merits and the expressiveness of the language of **Probability Graphical Model** at hand, modeling the social puzzle of support for political Islam that over tones of scholarly research has proven to multi-dimensional, complex and dynamic, while modeling as a Bayes net, it allows for a graphical presentation and a rather straight forward description that can take care of as many random variables we wanted to include in our model. the merits that, this project attempts to model the data generating process of how people came to support Islamist in 1988, or to evaluate whether we can really discern that of a single formula for these individuals.

The project wanted the **Bayesian humility** to show the complexity of social science subjects, we are going to see that Bayesian models tend not to out perform, yet what really matters is the generalizabiliy rather the the accuracy, they break down the modeling or inference process in order to make the implicit assumptions explicit. Because our subject of interest are human beings

Might public opinion surveys undermine the prevailing misconception on the religion and the culture
...
In the introduction of the 2017 book *Rethinking Political Islam*, they address specifically the question: How do Islamists-- and the international community-- measure Islamist success(@hamidRethinkingPoliticalIslam2017, pp. 11-13)^[Islamist sharing the parliament seats, Islamist doing poorly in elections might not always be a bad thing, since they might in turn am able to sustain its social base that was built gradually through social welfare and relgious education programs]
...
Now that we have the public opinion data ready, around a hundred questions answered, we can begin by listening to what our 885 respondents have to say, about their contexts.

Looking at individual survey items, we can already have the sense of what attitudes and opinions that people share, the commonalities and the variations

> election makes a poor analogy to civil war, the logic of state and church makes a poor analogy to the logic of the state and the Muslims
>

It would be nice to begin with letting the data to tell us part of the context of 1988
#### The Arab Bitterness

The resurgence of Islamic movement articulate very real and widespread popular grievances

### Sympathy to Support: How to measure "Popular Support"


Given the context that the experience of state and politics can vary widely among our respondents, yet the one of the commonality of the year 1988 is that they are all suffering from their **Authoritarian** regimes, then why public opinion surveys still matter? The reason given is that authoritarian is still very far from totalitarian, 

1. One way of thinking about popular support

> attitudes are unobservable and somehow must be inferred(@kalyvasLogicViolenceCivil2006)^[logic pp. 91-102] Yet below this unanimity lies extreme confusion, for there are two very different
...
> of the war.
> Conceptualizing support in attitudinal terms is common.

1. An equally misguided solution to the problem of unobservable attitudes is to derive them uncritically from “revealed” or observed behavior
...
The three samples we look at are from three populations that are very different in terms of size, therefore, we want to specify our confidence in how well these 3 sets of 300 respondents can be representative.
...
As for Kuwait, 2,134,707, which about 40% are citizens.^[https://www.macrotrends.net/global-metrics/countries/kwt/kuwait/population]

The population of Cairo of 1988, 9,169,000^[https://www.macrotrends.net/global-metrics/cities/22812/cairo/population]

> while using the population distribution to structure some dependence into the parameters, thereby avoid the problem of overfitting. (hierachical model can fit more params than there is data points)
